        ...
        <div class="mx-auto max-w-2xl lg:max-w-5xl">
          ...
          <div class="max-w-2xl">
            ...
            <div class="mt-6 flex gap-6"><a class="group -m-1 p-1" aria-label="Follow on Twitter"
                ...
                </svg></a><a class="group -m-1 p-1" aria-label="Follow on GitHub" href="https://github.com/schacon"><svg
                  viewBox="0 0 24 24" aria-hidden="true"
                  class="h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300">
                ...
                </svg></a><a class="group -m-1 p-1" aria-label="Follow on LinkedIn" href="https://linkedin.com/in/schacon"><svg
                  viewBox="0 0 24 24" aria-hidden="true"
                  class="h-6 w-6 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300">
                  <path
    ...
    <div class="-my-4 flex justify-center gap-5 overflow-hidden py-4 sm:gap-8">
      <div
        ...
        <img alt="" loading="lazy" width="3744" height="5616" decoding="async" data-nimg="1"
          ...
          src="{{ "/assets/images/italy.jpg" | relative_url }}"></div>
      <div
        class="relative aspect-[9/10] w-44 flex-none overflow-hidden rounded-xl bg-zinc-100 dark:bg-zinc-800 sm:w-72 sm:rounded-2xl -rotate-2">
