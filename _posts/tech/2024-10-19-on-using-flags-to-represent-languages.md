...
<figure>
  <img src="{{ "/assets/images/flags-unsplash-ferl.jpg" | relative_url }}" alt="A wall of national flags">
...
<figure>
  <img src="{{ "/assets/images/flags-recognizability.png" | relative_url }}" alt="Chart of global flag recognizability">
...
<figure>
  <img src="{{ "/assets/images/flags-bork-hacker.png" | relative_url }}" alt="A language dropdown listing options including Bork Bork Bork and Hacker">
...
<figure>
  <img src="{{ "/assets/images/flags-ausgangssprache.png" | relative_url }}" alt="A German-language interface labeled Ausgangssprache: Deutsch">
...
<figure>
  <img src="{{ "/assets/images/flags-polish-list.png" | relative_url }}" alt="A list of languages written in Polish, each next to its flag">
